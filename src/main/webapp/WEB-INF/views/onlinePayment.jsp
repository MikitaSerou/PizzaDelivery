...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/onlinePayment.css">
    ...
    <div class="row justify-content-center">
        <div class=" col-lg-6 col-md-8">
            <div class="card p-3">
                ...
                <form class="form-card" method="post" action="/onlinePayment">
                    ...
                    <div class="row justify-content-center form-group">
                        <div class="col-12 px-auto">
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label for="customRadioInline1" class="custom-control-label label-radio"><spring:message code="private"/></label> </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="customRadioInline2" type="radio" name="customRadioInline1" class="custom-control-input">
                                <label for="customRadioInline2" class="custom-control-label label-radio"><spring:message code="business"/></label> </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-12">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <div class="input-group"> <input type="text" id="cr_no" name="card-no" placeholder="0000 0000 0000 0000" minlength="19" maxlength="19" required>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="input-group">
                                        <input type="text" id="exp" name="expdate" placeholder="MM/YY" minlength="5" maxlength="5" required>
                                        <label><spring:message code="expiry.date"/></label> </div>
                                </div>
                                <div class="col-6">
                                    <div class="input-group">
                                        <input type="password" name="cvv" placeholder="&#9679;&#9679;&#9679;" minlength="3" maxlength="3" required>
                                        <label>CVV</label> </div>
                                </div>
                            </div>
                        </div>
