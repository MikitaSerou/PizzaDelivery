...
<div id="content" class="container" style="min-height: 80%">
    <div class="row">
        <div class="col-sm-9">
            ...
            <c:if test="${basket.basketItems.isEmpty()}">
            ...
            <c:if test="${!basket.basketItems.isEmpty()}">
                <div class="alert alert-primary">
                    <div class="row">
                        <div class="col">
                            <h2 class="display-2"><spring:message
                                    code="basket.title"/>:</h2>
                        </div>
                        <div class="col">
                            ...
                            <div class="btn-group btn-group-lg" role="group" aria-label="..."
                                ...
                                <a href="#editOrder">
                                    <button class="btn btn-warning btn-lg">
                                        <spring:message code="makeOrder.button"/>
                                    </button>
                                </a>
                    ...
                    <form method="POST">
                        <table width="100%">
                            <td>
                                <input type="hidden" class="form-control" name="basketId"
                                       value="${basket.id}">
                            ...
                            <td><label for="formGroupExampleInput3"><spring:message code="commentToOrder"/>:</label>
                                ...
                                <textarea id="formGroupExampleInput3" name="comment"
