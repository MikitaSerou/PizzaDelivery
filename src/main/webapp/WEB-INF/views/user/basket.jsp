        ...
        <div class="col-sm-9">
            <div class="card text-white bg-primary mb-3" style="max-width: 540px;">
                <div class="row no-gutters">
                    ...
                    <h2 class="display-2" align="left" margin="right"><spring:message code="basket.title"/>:</h2>
            ...
            <table class="table table-hover table-dark" style="border-radius: 15px; border: 1px black solid; width: 100%;">
                ...
                <th > <div class="btn-group btn-group-lg" role="group" aria-label="..." style="position:absolute; top:0; right:0;">
                    <form action="${pageContext.request.contextPath}/user/basket/${user.username}" method="post">
                        <input type="hidden" name="userName" value="${user.username}"/>
                        <input type="hidden" name="basketId" value="${basket.id}"/>
                        <input type="hidden" name="action" value="submit"/>
                        <button type="submit" class="btn btn-success btn-lg">
                            <spring:message code="takeOrder.button"/>
                        </button>
                    </form>
                    <form action="${pageContext.request.contextPath}/user/basket/${user.username}" method="post">
                        <input type="hidden" name="userName" value="${user.username}"/>
                        ...
                        <button type="submit" class="btn btn-danger btn-lg">
                            <spring:message code="clearBasket.button"/>
                        </button>
                    </form>
                </div></th>
                    ...
                    <tr class="table-secondary">
                        ...
                        <td style="margin-left: auto; margin-right: auto;">
                            ...
                            <form action="${pageContext.request.contextPath}/user/basket/${user.username}" method="post">
                                ...
                                <button type="submit" class="btn btn-warning" <%--style="position:absolute; top:0; right:0;"--%>>
...
<%--TODO написать нормальный футер--%>
