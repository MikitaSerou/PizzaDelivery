    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="mainpageParagraph">
                <p><spring:message code="p1"/></p>

                <div class="text-center">
                    <img src='<spring:url value="/resources/images/products/image lol.jpg" />' width="336" height="394"
                         class="rounded" alt="kek">
                </div>

                <br/>
                <figure class="text-end">
                    <blockquote class="blockquote">
                        <p class="quote"><spring:message code="quote.1"/></p>
                    </blockquote>
                    <figcaption class="blockquote-footer">
                        <cite title="Source Title"><spring:message code="quote.1.author"/></cite>
                    </figcaption>
                </figure>
                <br/>
                <p><spring:message code="p2"/></p>
                <div class="text-center">
                    <img src='<spring:url value="https://i.pinimg.com/564x/bf/84/45/bf8445c0ddb202c2f81b9a4af9fdba74.jpg"/>'
                         width="282px"
                         height="423px" class="rounded" alt="kek">
                </div>
                <p><spring:message code="p3"/></p>
                <br/>
                <figure class="text-end">
                    <blockquote class="blockquote">
                        <p class="quote"><spring:message code="quote.2"/></p>
                    </blockquote>
                    <figcaption class="blockquote-footer">
                        <cite title="Source Title"><spring:message code="quote.2.author"/></cite>
                    </figcaption>
                </figure>
                <br/>
