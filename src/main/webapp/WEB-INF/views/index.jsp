...
<head>
    ...
    <title>
        <spring:message code="main.title"/></title>
    ...
    <link href="/examples/vendors/bootstrap-4.1/css/bootstrap.min.css" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4" style="height:10%">
        ...
        <div class="btn-group btn-group-lg" role="group" aria-label="...">
            ...
            <sec:authorize access="!hasRole('ROLE_ADMIN')">
                <button type="button" class="btn btn-secondary"><a href="/constructor">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <h1 class="display-2" align="left" margin="right">
                <span id="pageHeader">&nbsp;<spring:message code="mainPage.title"/>&nbsp;</span>
            </h1>
            <br/>
            <br/>
            <div class="mainpageParagraph">
                <br/>
                <p><span class="formLable" style="font-size: 36px; color: white;"><spring:message
                        code="main.title"/></span>
                    <span><spring:message code="p1"/></span></p>

                <p><spring:message code="p2"/></p>
                <br/>
                <div class="container text-center" style="width: 100%">
                    <h1>
                        <span class="alert alert-warning"><spring:message code="top.product.offer"/></span></h1>
                    <br/>
                    <br/>
                    <br/>
                    <div id="carousel" class="carousel slide d-inline-block" data-ride="carousel" style="width: 100%">
                            ...
                            <div class="carousel-item active" style="width: 100%">
                                ...
                                <div class="carousel-item" style="width: 100%">
                                    ...
                                    <a href="/category/${product.category.name}/${product.name}">
                                        <img class="img-fluid"
                                             src="/resources/images/products/${product.name.toLowerCase()}.png"
                                    ...
                                    <div class="carousel-caption">
                                        <h3><span id="pizzaName">&nbsp;${product.name}&nbsp;</span></h3>
                                        <p><i id="ingredientName">&nbsp;${product.description}&nbsp;</i></p>
                                    </div>
                                </div>
                                </c:forEach>
                            </div>
                    ...
                    <p class="formLable" style="font-style: italic; color: white;">
                        <spring:message code="mail.conclusion"/></p>
                </div>
            </div>
