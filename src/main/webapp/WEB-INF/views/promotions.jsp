...
<head>
    ...
    <title><spring:message code="promotions.title"/></title>
...
<div class="sticky-top">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
        ...
        <a class="navbar-brand" href="/"><h1><img src='<spring:url value="/resources/images/logo/logoPBright.png"/>'/>
            <spring:message code="site.name"/></h1></a>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="?lang=en"><img
                        src='<spring:url value="/resources/images/en.png"/>'/><spring:message code="lang.en"/></a>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-9">
            <h1 class="display-2" align="left" margin="right"><spring:message code="promotions.title"/></h1>
            <p align="center"><img src='<spring:url value="/resources/images/logo.png"/>'/></p>
