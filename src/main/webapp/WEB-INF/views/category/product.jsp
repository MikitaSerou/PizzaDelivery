    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div style="min-height: auto">
                <div class="row no-gutters" id="productCard">
                    ...
                    <div class="col-md-7">
                        ...
                        <br/>
                        <h1><span
                                style="color: white; background-color: #ed5a56;border-radius: 10px;font-weight: bolder;font-size: 45px;">
                        ...
                        <form action="${pageContext.request.contextPath}/category/${category.name}/${product.name}"
                            ...
                            <select id="dropdown" class="form-control" name="baseId" style="max-width: 50%">
                            ...
                            <sec:authorize access="hasRole('ROLE_USER')">
                                <button type="submit" formmethod="post" class="btn btn-success"
                                    ...
                                    <spring:message code="addToBasket.button"/></span></button>
                            </sec:authorize>
                        </form>
                    </div>
                </div>
