...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <h1 class="display-2" align="left" margin="right"><spring:message code="category.title"/></h1>
            <br/>
            <br/>
            ...
            <br/>
            <sec:authorize access="hasRole('ROLE_ADMIN')">
                <div class="alert alert-success"><h1 class="display-4">Add new Category:</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <form action="${pageContext.request.contextPath}/category" method="post">
                                ...
                                <button type="submit" class="btn btn-danger" style="position:absolute; top:0; right:0;">
                                    Delete
                                </button>
                            </form>
                            </sec:authorize>
                    ...
                    <c:forEach var="product" items="${category.products}">
                        <div class="col mb-4">
                            <a href="/category/${product.id}">
                                <div class="card text-white bg-dark mb-4" style="width: 280px;">
