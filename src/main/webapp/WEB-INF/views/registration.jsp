    ...
    <div class="row justify-content-center align-items-center">
        ...
        <div class="col-sm-6" style="backdrop-filter: blur(7px); border-radius: 30px">
            ...
            <form:form action="${pageContext.request.contextPath}/registration" method="post"
                ...
                <div class="form-group">
                    <label for="formGroupExampleInput3"><spring:message code="phoneNumber"/></label>
                ...
                <div class="form-group">
                    ...
                    <span class="error"><spring:message code="${matchError}"/></span>
                </div>
                <div class="row justify-content-md-center">
                    ...
                    <button type="submit" class="btn btn-success">
                        ...
                        <spring:message code="registration.ref"/>
                    </button>
                </div>
                <br/>
            </form:form>
