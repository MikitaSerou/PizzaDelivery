                ...
                <div class="col-sm-5">
                    <div class="list-group">
                        <a href="admin/users" class="list-group-item list-group-item-action">
                            ...
                            <spring:message code="user.table"/></a>
                        <a href="${pageContext.request.contextPath}/category"
                           class="list-group-item list-group-item-action">
                            ...
                            <spring:message code="category.list"/></a>
                        <a href="admin/ingredients" class="list-group-item list-group-item-action">
                            ...
                            <spring:message code="ingredients.table"/></a>
                        <a href="admin/orders" class="list-group-item list-group-item-action">
                            ...
                            <spring:message code="activeOrders.table"/></a>
                        <a href="${pageContext.request.contextPath}/admin/archive"
                           class="list-group-item list-group-item-action">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
