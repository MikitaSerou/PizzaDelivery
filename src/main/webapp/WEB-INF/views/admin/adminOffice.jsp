...
<div class="sticky-top">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
        ...
        <a class="navbar-brand" href="/">
            <h1><img src='<spring:url value="/resources/images/logo/logoPBright.png"/>'/> <spring:message code="site.name"/>
            </h1>
        </a>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-9">
            <h1 class="display-2" align="left" margin="right"><spring:message code="adminOffice.title"/></h1>
            <br/>
            <br/>
            <div class="row">
                <div class="col-sm-5">
