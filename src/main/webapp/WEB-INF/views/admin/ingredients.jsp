        ...
        <div class="dropdown">
            <button class="btn btn-danger dropdown-toggle" type="button" id="dropdownMenuButton2"
                ...
                <img src='${pageContext.request.contextPath}/resources/images/<spring:message code="img.lang.now"/>.png'
                     width="28" height="20"
                     alt="lang.now"/><spring:message code="lang.now"/>
            </button>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="?lang=en">
                    <img src='<spring:url value="/resources/images/en.png"/>' alt="en"/><spring:message code="lang.en"/>
                </a>
                <a class="dropdown-item" href="?lang=ru"><img
                        src='<spring:url value="/resources/images/ru.png"/>' alt="ru"/><spring:message code="lang.ru"/>
                </a>
            </div>
        </div>
...
<div class="container" style="min-height: 80%">
    <div class="row">
        <div class="col-sm-9">
            <h1 class="display-2">
                <span id="pageHeader">&nbsp;<spring:message code="ingredients.table"/>&nbsp;</span>
            </h1>
        ...
        <table class="table table-hover table-dark" border="1">
            <thead>
            <td>ID</td>
            <td><spring:message code="p.name"/></td>
            <td><spring:message code="price"/></td>
            <td><spring:message code="ingredient.type"/></td>
            ...
            <tr class="bg-success">
                <form action="${pageContext.request.contextPath}/admin/ingredients" method="post">
                        ...
                        <div class="col">
                            <label>
                                <input type="number" min="1" max="10" step="0.1" class="form-control"
                                       name="ingredientPrice" placeholder="<spring:message code="price"/>">
                            </label>
                        </div>
                    </td>
                    <td>
                        <select class="form-control" name="ingredientType">
                    ...
                    <td>
                        ...
                        <button type="submit" formmethod="post" class="btn btn-light"><spring:message
                                code="add.button"/></button>
                    </td>
                </form>
            </tr>
                ...
                <tr class="bg-secondary">
                    <form action="${pageContext.request.contextPath}/admin/ingredients" method="post">
                        <td>
                            ...
                            <div class="col">
                                <input type="hidden" class="form-control" name="ingredientId" value="${ingredient.id}">
                            </div>
                        </td>
                        <td>
                            <input type="text" class="form-control" name="ingredientName"
