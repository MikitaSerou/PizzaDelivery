...
<div class="sticky-top">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
        ...
        <form class="form-inline my-2 my-lg-0" style="position:absolute; right:0;">
            ...
            <button class="btn btn-secondary my-2 my-sm-0" onclick="mysearch()"><spring:message code="search"/>
            </button>
        </form>
    </nav>
</div>
                                        ...
                                        <td>
                                            <h2 id="ingredientName" align="center"
                                                style="font-size: 20px"><span><img class="rounded"
                                                                                   ...
                                                                                   alt="${ingredientType.toString()}"/></span>
                                                <br/> <spring:message code="${ingredientType.toString()}"/>
                                            </h2></td>
                                    </c:if>
                                </c:forEach>
                            </tr>
