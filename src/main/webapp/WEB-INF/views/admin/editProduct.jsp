            ...
            <div class="card text-white bg-primary mb-3" style="width: 100%;">
                <div class="card-body">
                    <img class="img-fluid"
                         ...
                         alt="${product.name}" height="250" width="250"
                    ...
                    <form action="${pageContext.request.contextPath}/admin/edit/${productName}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="formInput2" name="ingredientsIds" style="max-width: 50%">
                                                            ...
                                                            <div class="custom-control custom-switch">
                                                                ...
                                                                && !ingredientType.toString().equals('Unstock')}">
                                                                    ...
                                                                    <label class="custom-control-label"
                                                                           for="${ingredient.id}">${ingredient.name}
                                                                    </label
                                                                </c:if>
                                                                <c:if test="${!product.ingredients.contains(ingredient)
                                                                && !ingredientType.toString().equals('Unstock')}">
