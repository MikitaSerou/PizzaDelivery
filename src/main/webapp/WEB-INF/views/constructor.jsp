                ...
                <div class="card-body">
                    ...
                    <form action="${pageContext.request.contextPath}/constructor" method="post">
                        <div class="form-group">
                            <label class="formLable" for="base">
                                <span style="font-size: 30px;"><spring:message code="choose.base"/></span>
                            </label>
                            <select id="base" class="form-control" name="baseId"
                                    style="max-width: 50%">
                        ...
                        <div class="form-group">
                            <label class="formLable" for="sauce"><span style="font-size: 30px;">
                                <img class="rounded" src='<spring:url value="/resources/images/ingredients/sauce.png"/>'
                                     width="50px" height="50px" alt="sauce"/>
                            </span><spring:message code="choose.sauce"/></label>
                            <select class="form-control" id="sauce" name="sauceId"
                                    style="max-width: 50%">
                                <option name="sauceId" value="0" data-price="0"><spring:message
                                        code="without.sauce"/></option>
                                <c:forEach items="${sauces}" var="sauce">
                                    <option id="sauceId" name="sauceId"
                                            value=${sauce.id} data-price="${sauce.price}">${sauce.name}&nbsp;
                                        ...
                                        <td><h2 id="ingredientName" align="center"
                                                ...
                                                <span>
                                                    <img class="rounded"
                                                         ...
                                                         alt="ingredientType.toString()"/></span><br/>
                        ...
                        <br/>
                        <div><h1><spring:message code="price"/>: <span id="result"></span>&nbsp;
                            <span><spring:message code="currency"/></span></h1>
                        </div>
                        <sec:authorize access="hasRole('ROLE_USER')">
                            <button formmethod="post" type="submit" class="btn btn-success">
                                <span style="font-size: 30px;"><spring:message code="addToBasket.button"/></span>
                            </button>
                        </sec:authorize>
                    </form>
                </div>
