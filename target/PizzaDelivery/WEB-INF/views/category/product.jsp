...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <h1 class="display-2" align="left" margin="right">${product.name}</h1>
            <span class="BackButton" align="left"> <a href="/category">Назад</a></span>
            <table>
                <tr>
                    <th align="left">
                        <h2>${product.name}</h2>
                ...
                <div class="card text-white bg-dark mb-4">
                    <sec:authorize access="isAuthenticated()">
                        <h4 class="display-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                                ...
                                ${pageContext.request.userPrincipal.name} <%--УБРАТЬ--%>
                        </h4>
                    </sec:authorize>
                    <sec:authorize access="hasRole('ROLE_ADMIN')">
                    ...
                    <sec:authorize access="hasRole('ROLE_USER')">
                        <div class="list-group">
                            ...
                            <a href="/user/basket/${pageContext.request.userPrincipal.name}" class="list-group-item list-group-item-action">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<%--<div id="myFooter">
    Серов Никита Вадимович | Mikita.Serou@gmail.com | +375(29) 105-16-07
</div>--%>
